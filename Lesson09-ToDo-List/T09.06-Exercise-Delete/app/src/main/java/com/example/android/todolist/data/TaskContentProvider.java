    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case TASK_WITH_ID:
                ...
                String mSelection = "_id=?";                                        //SOLUTION DIDN'T INCLUDE AS VARIABLES
                String[] mSelectionArgs = new String[]{id};

                deletedTasks = db.delete(TABLE_NAME, mSelection, mSelectionArgs);
//                db.delete(TaskContract.TaskEntry.TABLE_NAME, mSelection, mSelectionArgs);
//                deletedTasks ++;
