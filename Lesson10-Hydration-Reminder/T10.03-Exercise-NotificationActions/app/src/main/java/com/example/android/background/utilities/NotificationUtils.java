...
public class NotificationUtils {
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent ignoreReminderPendingIntent = PendingIntent.getService(
                context, ACTION_IGNORE_PENDING_INTENT, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        NotificationCompat.Action ignoreReminderAction = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,
                "No, Thanks.", ignoreReminderPendingIntent);                   //SOLUTION DOESN'T HAVE NotifCompat, JUST Action
        //      COMPLETED (10) Return the action
        return ignoreReminderAction;                                                //IT APPEARS THAT THEY IMPORTED IT
    }
